...
import priv.jesse.mall.entity.pojo.SearchBean;
...
public class ProductController {
    ...
    public String toList(String keyword, Map<String, Object> map) {
        SearchBean searchBean = new SearchBean();
        searchBean.setKeyword(keyword);
        map.put("search", searchBean);
    ...
    public ResultBean<List<Product>> getBySearch(String keyword, Integer pageSize, Integer pageNo) {
        List<Product> products = productService.findBySearch(keyword, pageSize, pageNo);
